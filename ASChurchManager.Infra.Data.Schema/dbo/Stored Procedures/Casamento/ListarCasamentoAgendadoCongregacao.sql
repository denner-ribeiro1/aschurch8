CREATE PROCEDURE [dbo].[ListarCasamentoAgendadoCongregacao]
	@Id INT,
	@CongregacaoId INT,
...
BEGIN
	...
	WHERE 
		@Id = 0
		AND CA.CongregacaoId = @CongregacaoId
		AND (CONVERT(DATETIMEOFFSET, CONVERT(SMALLDATETIME, CA.DataHoraInicio)) BETWEEN CONVERT(DATETIMEOFFSET, CONVERT(SMALLDATETIME, @DataHoraInicio)) AND CONVERT(DATETIMEOFFSET, CONVERT(SMALLDATETIME, @DataHoraFinal))
			 OR CONVERT(DATETIMEOFFSET, CONVERT(SMALLDATETIME, CA.DataHoraFinal)) BETWEEN CONVERT(DATETIMEOFFSET, CONVERT(SMALLDATETIME, @DataHoraInicio)) AND CONVERT(DATETIMEOFFSET, CONVERT(SMALLDATETIME, @DataHoraFinal)))
