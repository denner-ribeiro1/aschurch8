;(function ($, window, document, undefined) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      ...
      removeSelectedLabel: 'Remove selecionados',
      ...
      infoText: 'Item(ns) selecionado(s) {0}',                                                        // text when all options are visible / false for no info text
      ...
      infoTextEmpty: 'Nenhum item selecionado',                                                        // when there are no options present in the list
